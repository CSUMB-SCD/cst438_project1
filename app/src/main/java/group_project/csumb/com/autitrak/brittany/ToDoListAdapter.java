...
public class ToDoListAdapter extends RecyclerView.Adapter<ToDoListAdapter.ListItemViewHolder>{
    ...
    public void onBindViewHolder(ListItemViewHolder holder, int position) {
        ...
        holder.txtReward.setText(String.valueOf(itemList.get(position).getReward()));
    }
    ...
    public class ListItemViewHolder extends RecyclerView.ViewHolder {
        TextView txtDescription, txtPoints, txtLevel, txtStartDate, txtEndDate, txtReward;
        ...
        public ListItemViewHolder(View itemView) {
            ...
            txtReward = (TextView)itemView.findViewById(R.id.idReward);
        }
    }
}
